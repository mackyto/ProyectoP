...
public class Cliente extends Persona {
    ...
    private List<Pedido> listaPedidos;
        ...
        /**
     * Constructor de cliente inicializando la lista de pedidos con id automático
     * @param email del cliente
     * @param nivelFidelidad del 1 al 5 sobre el nivel de transacciones del cliente
     ...
     * @param email del cliente
     * @param nivelFidelidad del 1 al 5 sobre el nivel de transacciones del cliente
     * @param listaPedidos la lista de los pedidos del cliente, que puede estar vacía.
     * @param nombre Clase super Persona nombre de persona
     * @param apellidos Clase super Persona apellidos de persona
     * @param telefono  Clase super Persona telefono de persona
     * @param id  Clase super identificador nombre de persona
     ...
     * @return pedido, el pedido si lo hubiera que coincide con el parametroi de busqueda 
     * @throws ErrorDatos 
     */
